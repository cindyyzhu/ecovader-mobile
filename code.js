...
onEvent("heart2", "click", function( ) {
  if (likedPost2 == false) {
    likedPost2 = true;
    showElement("greenHeart2");
    likes2++;
    setText("likesNumber2", likes2);
  } else if (likedPost2 == true) {
    hideElement("greenHeart2");
    likedPost2 = false;
    likes2 --;
    setText("likesNumber2", likes2);
  }
});
onEvent("shareButton2", "click", function ( ) {
  showElement("sharePopUp2");
  showElement("exitPopUp2");
  showElement("copyButton2");
  if (copiedPost2 == true) {
    showElement("copiedButton2");
  }
});
onEvent("exitPopUp2", "click", function ( ) {
  hideElement("sharePopUp2");
  hideElement("exitPopUp2");
  hideElement("copyButton2");
  hideElement("copiedButton2");
});
onEvent("copyButton2", "click", function( ) {
  if (copiedPost2 == false) {
    copiedPost2 = true;
    showElement("copiedButton2");
  }
});

onEvent("postCommentsButton", "click", function( ) {
  var communityComments = getProperty("enterComments", "value");
  console.log(communityComments);
  if (communityComments == "") {
    setScreen("nowInToronto");
  } else {
    setProperty("enterComments", "text", "Posted!");
    hideElement("leaveAComment");
    setText("commentText", communityComments);
  }
  createRecord("communityCommentsLog", {comments:communityComments}, function() {
    setTimeout(function() {
      setProperty("enterComments", "text", "");
    }, 2000);
  });
});
onEvent("commentsButton", "click", function( ) {
  setScreen("comments");
});
onEvent("nextPostButton", "click", function( ) {
  setScreen("nowInToronto2");
});
onEvent("nextPostButton2", "click", function( ) {
  setScreen("nowInToronto3");
});
...
onEvent("prevPostButton", "click", function( ) {
  setScreen("nowInToronto");
});
onEvent("prevPostButton2", "click", function( ) {
  setScreen("nowInToronto2");
});